...
#import "XHPEdgeInsetsButton.h"

@implementation XHPEdgeInsetsButton
...
- (void)setEdgeInsetsStyle:(XHPButtonEdgeInsetsStyle)edgeInsetsStyle {
    ...
    switch (edgeInsetsStyle) {
        case XHPButtonEdgeInsetsStyleImageRight:
        {
            space = space * 0.5;
        ...
        case XHPButtonEdgeInsetsStyleImageLeft:
        {
            space = space * 0.5;
            ...
            break;
        case XHPButtonEdgeInsetsStyleImageBottom:
        {
            ...
            break;
        case XHPButtonEdgeInsetsStyleImageTop:
        {
            CGFloat imageHeight = CGRectGetHeight(self.imageView.frame);
            CGFloat labelHeight = CGRectGetHeight(self.titleLabel.frame);
            CGFloat buttonHeight = CGRectGetHeight(self.frame);
